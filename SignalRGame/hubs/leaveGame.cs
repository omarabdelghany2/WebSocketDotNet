...
namespace SignalRGame.Hubs
{
    ...
    {
        public async Task<string> leaveGame(leaveGameRequest request)
        {
            ...
            if (isHost)
            {
                ...
                else
                {
                    ...
                    await Clients.Group(roomId).SendAsync("playerLeftGame" ,new{userId=Convert.ToInt32(userId),team=player.team}); 
